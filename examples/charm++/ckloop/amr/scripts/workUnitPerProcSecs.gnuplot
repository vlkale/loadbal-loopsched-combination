...
plot 'workUnitPerProcSecs.160' using 1:2 with linespoints ls 1 title "depth8",\
     ...
     'workUnitPerProcSecs.180' using 1:2 with linespoints ls 2 title "depth9",\
     'workUnitPerProcSecs.200' using 1:2 with linespoints ls 3 title "depth10",\
     'workUnitPerProcSecs.220' using 1:2 with linespoints ls 4 title "depth11"
