...
set ylabel 'ts/proc/sec'
set xtics autofreq nomirror (1,16,32,64,128,256,512,1024,2048)
set ytics autofreq 10
set mytics 5
set yrange [0.01:100]
set xrange [0.5:8096]
plot 'timestepPerProcSecs.160' using 1:2 with linespoints ls 1 title "depth8",\
     'timestepPerProcSecs.160' using 1:3 with linespoints ls 10 title "",\
     'timestepPerProcSecs.180' using 1:2 with linespoints ls 2 title "depth9",\
     'timestepPerProcSecs.200' using 1:2 with linespoints ls 3 title "depth10",\
     'timestepPerProcSecs.220' using 1:2 with linespoints ls 4 title "depth11"
