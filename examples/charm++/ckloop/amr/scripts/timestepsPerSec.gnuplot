...
set yrange [1:10000]
set xrange [0.5:8096]
plot 'timestepPerSec.160' using 1:2 with linespoints ls 1 title "depth8",\
     'timestepPerSec.220' using 1:3 with linespoints ls 10 title "",\
     'timestepPerSec.180' using 1:2 with linespoints ls 2 title "depth9",\
     'timestepPerSec.200' using 1:2 with linespoints ls 3 title "depth10",\
     'timestepPerSec.220' using 1:2 with linespoints ls 4 title "depth11"
